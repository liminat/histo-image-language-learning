...
def get_default_params(model_name):
    ...
    elif model_name in ["ViT-B/32","ViT-S/16"]:
...
def parse_args():
    ...
    #     "--train-data",
    #     type=str,
    #     default="/data1/dri/open_clip/data/quilt1m/quilt_1M_lookup_updated.csv",
    #     help="Path to csv filewith training data",
    # )
    parser.add_argument(
        "--train-data",
        type=str,
        default="/data1/dri/open_clip/data/quilt1m/quilt_1M_lookup_TRAIN.csv",
        help="Path to csv filewith training data",
    )
    parser.add_argument(
        "--val-data",
    ...
    #     "--nct",
    #     type=str,
    #     default="/data1/dri/open_clip/data/CRC-VAL-HE-7K",
    #     help="Path to crc7k for conducting zero shot evaluation.",
    # )
    ...
    # )
    parser.add_argument(
        "--batch-size", type=int, default=850, help="Batch size per GPU."
    )
    # parser.add_argument(
    ...
    # parser.add_argument(
    #     "--resume",
    #     default='/data1/dri/open_clip/logs/lr=0.0005_wd=0.2_agg=True_model=ViT-B/32_batchsize=512_workers=1_date=2023-09-07-09-03-20/checkpoints/epoch_32.pt',
    #     type=str,
    ...
    parser.add_argument(
        "--model",
        choices=["RN50", "RN101", "RN50x4", "ViT-B/32", "ViT-S/16"],
        default="RN50",
